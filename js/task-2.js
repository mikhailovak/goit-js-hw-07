...
const galleryItem = images.map(image => {
  return `<li><img src="${image.url}" alt="${image.alt}" width=360px height=300px></li>`;
}).join("");
...
//-отримати доступ до галері
//-зпамувати на кожній ітерації дані з масиву за допомогою шаблонних рядків
//-поєднати усі рядки в один
//-додати код в хтмл
